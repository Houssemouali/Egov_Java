...
import Adapters.AdapterFacture;
 ...
 * @author Maynoo
 */
public class ValiderFacture extends javax.swing.JFrame {

    /**
     * Creates new form Authentification
     */
    public ValiderFacture() {

        initComponents();
        Design.setBackground();
        Image titreimg = Design.getTitre();

        this.setTitle("Valider Facture");
        titreLabel.setText("Valider Facture");
        titreBack.setIcon(new ImageIcon(titreimg));

        AdapterFacture tableAdapter = new AdapterFacture();
    ...
    private void commenterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_commenterActionPerformed
        FactureDao dd = new FactureDao();
        Facture d = dd.RechercherParId(Integer.parseInt(id.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValiderFacture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
