 ...
 * @author Maynoo
 */
public class ValiderCompteCourant extends javax.swing.JFrame {

    /**
     * Creates new form Authentification
     */
    public ValiderCompteCourant() {

        initComponents();
        Design.setBackground();
        Image titreimg = Design.getTitre();

        this.setTitle("Valider Compte Courant");
        titreLabel.setText("Valider Compte Courant");
        titreBack.setIcon(new ImageIcon(titreimg));

        AdapterCompteCourant tableAdapter = new AdapterCompteCourant();
    ...
    private void validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validerActionPerformed
        ...
        dd.Modifier(d);
        Compte c = new Compte();
        c.setCin(loginInfo.getUtilisateur().getCin());
        c.setId(0);
        c.setMontant(0);
        Random r = new Random();
        String s="5359";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValiderCompteCourant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
