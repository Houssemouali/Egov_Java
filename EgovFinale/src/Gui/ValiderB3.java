 ...
 * @author USER
 */
public class ValiderB3 extends javax.swing.JFrame {
    ...
    public ValiderB3() {
        ...
        this.setTitle("Valider Bulletin n°3");
        titreLabel.setText("Valider Bulletin n°3");
        titreBack.setIcon(new ImageIcon(titreimg));

        AdapterB3 tableAdapter = new AdapterB3();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValiderB3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
