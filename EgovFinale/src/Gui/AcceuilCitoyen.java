 ...
 * @author Maynoo
 */
public class AcceuilCitoyen extends javax.swing.JFrame {

    /**
     * Creates new form Authentification
     */
    public AcceuilCitoyen() {

        initComponents();
        Design.setBackground();
        Image titreimg = Design.getTitre();
        this.setTitle("Acceuil");
        titreLabel.setText("Acceuil");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcceuilCitoyen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AcceuilCitoyen().setVisible(true);
            }
        });
    }
