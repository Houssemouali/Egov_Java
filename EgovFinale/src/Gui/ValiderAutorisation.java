...
import Adapters.AdapterAutorisation;
 ...
 * @author Maynoo
 */
public class ValiderAutorisation extends javax.swing.JFrame {

    /**
     * Creates new form Authentification
     */
    public ValiderAutorisation() {

        initComponents();
        Design.setBackground();
        Image titreimg = Design.getTitre();

        this.setTitle("Valider Autorisation");
        titreLabel.setText("Valider Autorisation");
        titreBack.setIcon(new ImageIcon(titreimg));

        AdapterAutorisation tableAdapter = new AdapterAutorisation();
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        commentaire.setText(model.getValueAt(table.getSelectedRow(), 6).toString());
    }//GEN-LAST:event_tableMouseClicked

    private void commenterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_commenterActionPerformed
        AutorisationDao dd = new AutorisationDao();
        Demandeautorisation d = dd.RechercherParId(Integer.parseInt(id.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValiderAutorisation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
